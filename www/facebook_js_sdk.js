    ...
    if (FB._nativeInterface) {
        switch (params.method) {
            ...
            case 'login.status':
                ...
                break;
            case 'feed':
                FB._nativeInterface.dialog(params, cb, function(e) {alert('PhoneGap Facebook Connect plugin fail on auth.status!');});
                break;
            case 'apprequests':
                FB._nativeInterface.dialog(params, cb, function(e) {alert('PhoneGap Facebook Connect plugin fail on auth.status!');});
            break;
...
FB.provide('', {
  ...
  init: function(options) {
    ...
    if (FB._nativeInterface) {
      FB._nativeInterface.init(FB._apiKey, function(e) {alert('PhoneGap Facebook Connect plugin fail on init!');});
    }
